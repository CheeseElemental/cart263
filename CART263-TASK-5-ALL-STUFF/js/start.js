...
/** TASK 1:(Drawing Board A) - 
  ...
  You can use the mouse coordinates - the canvas ALREADY has event listeners for mouse click and mouse move implemeneted, as well as the proper mouseX and mouseY (NO need to add)
